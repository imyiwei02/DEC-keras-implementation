...
class DEC(object):
    ...
    def pretrain(self, x, y=None, optimizer='adam', epochs=200, batch_size=256, save_dir='results/temp'):
        ...
        self.autoencoder.save_weights(save_dir + '/ae_weights.weights.h5')
        print('Pretrained weights are saved to %s/ae_weights.weights.h5' % save_dir)
    ...
    def fit(self, x, y=None, maxiter=2e4, batch_size=256, tol=1e-3,
        ...
        save_interval = max(int(x.shape[0] / batch_size) * 5, 1)  # 5 epochs, minimum 1
        ...
        for ite in range(int(maxiter)):
            ...
            if ite % save_interval == 0:
                print('saving model to:', save_dir + '/DEC_model_' + str(ite) + '.weights.h5')
        ...
        logfile.close()
        print('saving model to:', save_dir + '/DEC_model_final.weights.h5')
